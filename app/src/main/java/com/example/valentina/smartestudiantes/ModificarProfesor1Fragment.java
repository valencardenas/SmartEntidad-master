 ...
 */
public class ModificarProfesor1Fragment extends Fragment {
    private AlertDialog.Builder dialogo;

    public ModificarProfesor1Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_modificar_profesor1, container, false);
        Button bModificar= (Button)view.findViewById(R.id.bModificarP2);
        Button bCancelar = (Button) view.findViewById(R.id.bCancelarP2);
        ...
        bModificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogo.setMessage(getResources().getString(R.string.MofPr));
    ...
    public void aceptar() {
        Toast t=Toast.makeText(getActivity().getApplicationContext(),getResources().getString(R.string.modificadoP), Toast.LENGTH_SHORT);
        t.show();
        Fragment fragment = null;
        fragment = new ProfesoresFragment();
        FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
